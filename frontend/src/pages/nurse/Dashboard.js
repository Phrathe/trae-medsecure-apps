          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <button className="text-primary-600 hover:text-primary-900 mr-3">View History</button>
...
const VitalSigns = () => (
  <div className="p-4">
    <h2 className="text-xl font-semibold mb-4">Record Vital Signs</h2>
    <div className="card">
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-700 mb-2">Patient</label>
        <select className="form-input py-2 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        <div>
          ...
          <input type="number" step="0.1" className="form-input py-2 w-full" placeholder="36.5" />
        </div>
        
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Heart Rate (BPM)</label>
          <input type="number" className="form-input py-2 w-full" placeholder="75" />
        </div>
        
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Blood Pressure (mmHg)</label>
          <div className="flex space-x-2">
            <input type="number" className="form-input py-2 w-full" placeholder="120" />
            <span className="flex items-center">/</span>
            <input type="number" className="form-input py-2 w-full" placeholder="80" />
          </div>
        </div>
        
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Respiratory Rate (breaths/min)</label>
          <input type="number" className="form-input py-2 w-full" placeholder="16" />
        </div>
        
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Oxygen Saturation (%)</label>
          <input type="number" className="form-input py-2 w-full" placeholder="98" />
        </div>
        
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Pain Level (0-10)</label>
          <input type="number" min="0" max="10" className="form-input py-2 w-full" placeholder="0" />
        </div>
      </div>
      
      <div className="mb-4">
        <label className="block text-sm font-medium text-gray-700 mb-2">Additional Notes</label>
        <textarea className="form-input py-2 w-full h-20" placeholder="Any additional observations..."></textarea>
      </div>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap">
                <span className="badge badge-primary">Updated Record</span>
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                Michael Peterson
              </td>
...
const Dashboard = () => {
  ...
  // Navigation items
  const navItems = [
    { path: '', label: 'Patient Records', icon: 'users' },
    { path: 'vitals', label: 'Record Vitals', icon: 'chart-bar' },
        ...
        <div className="flex flex-col w-64 border-r border-gray-200 bg-white">
          <div className="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="mt-5 flex-1 px-2 space-y-1">
              {navItems.map((item) => {
                const isActive = location.pathname === `/nurse/${item.path}`;
                return (
                  <Link
                    key={item.path}
                    to={item.path}
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div className="flex-shrink-0 w-full group block">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-700">{user?.name || 'Nurse Johnson'}</p>
                  <button 
